...
const arcgisFeatureLayerQuery = `?f=json&where=Confirmed%20%3E%200&returnGeometry=false&spatialRel=esriSpatialRelIntersects&outFields=*&orderByFields=Confirmed%20desc%2CCountry_Region%20asc%2CProvince_State%20asc&outSR=102100&resultOffset=0&resultRecordCount=500&cacheHint=true`;
const arcgisFeatureLayerUrl = `${arcgisFeatureLayerUrlBase}${arcgisFeatureLayerQuery}`;
